            ...
            <div class="projects-one project-one__home-one">
                <div class="container">
                    <div class="block-title text-center">
                        ...
                        <div class="thm-swiper__slider swiper-container" data-swiper-options='{"spaceBetween": 0, "slidesPerView": 1, "loop": false, "slidesPerGroup": 1, "pagination": {
                                ...
                                <?php foreach ($filteredProducts as $product) { ?>
                                    <div class="content">
                                        <a href="detail-product.php?id=<?= $product['id'] ?>">
                                            <img src="https://cms-pangalengan.desaumkm.com<?= $product['attributes']['foto_produk']['data'][0]['attributes']['url'] ?>" width="500" height="300" alt="" style="max-width: 100%; height: 200px;">
                                            <h3 style="font-size: 16px;"><?= $product['attributes']['nama_produk'] ?></h3>
                                            <h6 style="font-size: 13px;"><?= $product['attributes']['harga_produk'] ?></h6>
                                        </a>
                                    </div>
                                <?php } ?>
                            </div>
